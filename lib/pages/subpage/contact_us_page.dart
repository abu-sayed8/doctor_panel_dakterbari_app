...
class _ContactUsState extends State<ContactUs> {
  ...
  Widget _bodyUI(Size size,DoctorProvider drProvider) {
    return Container(
      //color: Colors.red,
      height: size.height,
      width: size.width,
                            ...
                            GestureDetector(
                                onTap: ()async{
                                  if(_formKey.currentState.validate()){
                                    drProvider.loadingMgs='Sending your message...';
                                    showLoadingDialog(context, drProvider);
                                    await drProvider.sendMessageToAdmin(context, _scaffoldKey, name, email, mgs);
                                  }
                                },
