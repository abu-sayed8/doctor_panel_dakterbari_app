...
import 'package:doctor_panel/widgets/comment_modal.dart';
import 'dart:async';
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: FormDecorationWithoutPrefix.copyWith(
                      ...
                      labelStyle:TextStyle(fontSize: size.width*.033,),fillColor: Color(0xffF4F7F5)),
                ),
              ),
              SizedBox(height: 10),
                  ...
                  child: InkWell(
                    onTap: ()async{
                      if(_formKey.currentState.validate()){
                        ...
                        await articleProvider.writeComment(widget.id,doctorProvider.doctorList[0].id,
                            doctorProvider.doctorList[0].fullName, doctorProvider.doctorList[0].photoUrl,
                            comController.text, context, _scaffoldKey).then((value) => comController.clear());
                      }
                    },
                ...
                child: Column(
                  ...
                  children: [
                    Text(articleProvider.articleCommentList[index].commenterName
                        ,style: TextStyle(fontSize: size.width*.036 , color: Colors.grey[900],fontWeight: FontWeight.bold)),
                    ...
                    Text(
                      ...
                      style: TextStyle(fontSize: size.width*.028, color: Colors.grey[700]),
                    ),
                  ],
                ),
              )
