import 'package:doctor_panel/pages/subpage/add_medicine_page.dart';
import 'package:doctor_panel/pages/subpage/medicine_details.dart';
...
class _MedicinePageState extends State<MedicinePage> {
  ...
  filterList() {
    ...
    if (searchController.text.isNotEmpty) {
      medicines.retainWhere((medicine) => medicine.name
          .toLowerCase()
